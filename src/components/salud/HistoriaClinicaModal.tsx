    ...
    try {
      ...
      if (flagsChanged) {
        await actualizarRefugiado(refId, {
          ...
          parroquia: refOriginal!.parroquia,
          ...
          mascota_foto_url: refOriginal!.mascota_foto_url,
          foto_url: refOriginal!.foto_url,
          ...
          observaciones: refOriginal!.observaciones,
          observaciones_generales: refOriginal!.observaciones_generales,
          parentesco: refOriginal!.parentesco,
          hogar_solidario: refOriginal!.hogar_solidario,
